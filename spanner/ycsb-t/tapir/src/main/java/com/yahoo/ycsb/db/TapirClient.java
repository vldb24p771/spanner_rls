...
public class TapirClient extends DB {
   ...
   public static final String CLIENTNUMBER = "tapir.clientNumber";
   ...
   public void init() throws DBException {
      ...
      int clientNumber = Integer.parseInt(props.getProperty(CLIENTNUMBER));
      int closestReplica = Integer.parseInt(props.getProperty(REPLICA));
      
      client = new Client(configPath, nshards, clientNumber, closestReplica);
   }
