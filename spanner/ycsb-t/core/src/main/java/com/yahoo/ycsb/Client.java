	...
	public static void main(String[] args)
	{
		...
		while (args[argindex].startsWith("-"))
		{
			if (args[argindex].compareTo("-threads")==0)
			{
				...
				{
					System.out.println("-threads argindex>=args.length\n");
					usageMessage();
					System.exit(0);
				}
			...
			else if (args[argindex].compareTo("-target")==0)
			{
				...
				if (argindex>=args.length)
				{
					System.out.println("-target argindex>=args.length\n");
					usageMessage();
					System.exit(0);
				}
			...
			else if (args[argindex].compareTo("-p")==0)
			{
				...
				if (argindex>=args.length)
				{
					System.out.println("-p argindex>=args.length\n");
					usageMessage();
					System.exit(0);
				}
		...
		if (argindex!=args.length)
		{
			System.out.println(argindex + args.length + "argindex!=args.length\n");
			usageMessage();
			System.exit(0);
		}
