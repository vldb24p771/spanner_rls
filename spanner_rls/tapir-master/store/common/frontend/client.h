...
public:
    ...
    // Begin a transaction.
    virtual void Begin(std::vector<std::pair<std::string, std::string>> keylist, bool inorcross) = 0;
    ...
    virtual bool PreCommit(std::vector<std::pair<std::string, std::string>> keylist) = 0;
